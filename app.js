...
const baseRecipes = [
...

    {
      ...
      difficulty: "Facile",
      ingredients: [
        { name: "Pastèque", quantity: "300 g", category: "" },
        { name: "Feta", quantity: "100 g", category: "" },
        { name: "Concombre", quantity: "1", category: "" },
        { name: "Menthe", quantity: "1 càs", category: "" },
        { name: "Citron", quantity: "1 càs", category: "" },
        { name: "Huile d’olive", quantity: "1 càs", category: "" },
      ],
      steps: [
        "Couper la pastèque et le concombre en dés.",
        "Émietter la feta.",
        "Mélanger dans un saladier.",
        "Ajouter citron, huile et menthe.",
        "Servir bien frais.",
      ],
    },
    {
      id: "r152",
      name: "Pâtes au citron & courgettes",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
      ...
      steps: [
        "Cuire les pâtes.",
        "Râper les courgettes et les faire revenir.",
    ...
    {
      id: "r153",
      name: "Poulet grillé marinade citron basilic",
      type: RecipeType.VIANDE,
      durationMinutes: 25,
      difficulty: "Facile",
      ingredients: [
        { name: "Poulet", quantity: "300 g", category: "" },
        { name: "Citron", quantity: "1", category: "" },
        { name: "Basilic", quantity: "1 poignée", category: "" },
        { name: "Huile d’olive", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Mélanger citron, huile et basilic.",
        "Enrober le poulet.",
        "Cuire à la poêle 10–12 minutes.",
    ...
    {
      id: "r154",
      name: "Salade tomates pêches burrata",
      type: RecipeType.VEGE,
      durationMinutes: 10,
      difficulty: "Facile",
      ingredients: [
        { name: "Tomates", quantity: "3", category: "" },
        { name: "Pêches", quantity: "2", category: "" },
        { name: "Burrata", quantity: "1", category: "" },
        { name: "Huile d’olive", quantity: "1 càs", category: "" },
        { name: "Vinaigre balsamique", quantity: "1 càs", category: "" },
      ],
      steps: [
        "Couper tomates et pêches.",
        "Déposer la burrata au centre.",
        "Assaisonner huile + balsamique.",
        "Servir frais.",
      ],
    },
    {
      id: "r155",
      name: "Wraps thon concombre citron",
      type: RecipeType.VIANDE,
      durationMinutes: 15,
      difficulty: "Facile",
      ingredients: [
        ...
        { name: "Thon", quantity: "1 boîte", category: "" },
        { name: "Concombre", quantity: "1", category: "" },
        { name: "Yaourt", quantity: "1 càs", category: "" },
        { name: "Citron", quantity: "1 càs", category: "" },
      ],
      steps: [
        "Mélanger thon et yaourt.",
        "Couper concombre.",
    ...
    {
      id: "r156",
      name: "Taboulé menthe & citron (version été)",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Semoule", quantity: "150 g", category: "" },
        { name: "Citrons", quantity: "2", category: "" },
        { name: "Persil", quantity: "1 botte", category: "" },
      ...
      steps: [
        "Cuire semoule.",
        "Hacher herbes.",
        "Mélanger avec citron, huile.",
        "Servir frais après 10 min repos.",
      ],
    },
    {
      id: "r157",
      ...
      ingredients: [
        ...
        { name: "Oignon", quantity: "1", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Herbes", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Couper légumes.",
        "Assembler en brochettes.",
        "Badigeonner d’huile.",
        "Griller 8–10 minutes.",
      ],
    },
    {
      id: "r158",
      name: "Crevettes citron ail express",
      type: RecipeType.POISSON,
      durationMinutes: 15,
      difficulty: "Facile",
      ingredients: [
    ...
    },
    {
      ...
      ingredients: [
        ...
        { name: "Tomate", quantity: "1", category: "" },
        { name: "Concombre", quantity: "1", category: "" },
        { name: "Feta", quantity: "50 g", category: "" },
        { name: "Huile d’olive", quantity: "1 càs", category: "" },
        { name: "Citron", quantity: "1 càs", category: "" },
      ],
      steps: [
        "Mélanger riz, légumes et feta.",
        "Ajouter huile et citron.",
        "Servir froid.",
      ],
    },
    {
      id: "r160",
      name: "Tartines ricotta tomates cerises",
      type: RecipeType.VEGE,
      durationMinutes: 10,
      difficulty: "Facile",
      ingredients: [
        { name: "Pain grillé", quantity: "4 tranches", category: "" },
        { name: "Ricotta", quantity: "100 g", category: "" },
        { name: "Tomates cerises", quantity: "150 g", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
    ...
    {
      id: "r161",
      name: "Velouté de potimarron rapide",
      type: RecipeType.VEGE,
      durationMinutes: 25,
      difficulty: "Facile",
      ingredients: [
        { name: "Potimarron", quantity: "1", category: "" },
        { name: "Oignon", quantity: "1", category: "" },
        { name: "Eau ou bouillon", quantity: "500 ml", category: "" },
        { name: "Crème (optionnel)", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Couper le potimarron en cubes.",
        "Émincer l’oignon.",
        "Faire revenir l’oignon puis ajouter potimarron.",
        "Ajouter l’eau et cuire 15 minutes.",
        "Mixer, ajouter sel (et crème si souhaité).",
      ],
    },
    {
      id: "r162",
      name: "Poêlée automnale champignons & ail",
      type: RecipeType.VEGE,
      durationMinutes: 15,
      difficulty: "Facile",
      ingredients: [
      ...
      steps: [
        ...
        "Ajouter champignons, sel et poivre.",
        "Cuire 6–8 minutes et servir.",
      ],
    },
    {
      id: "r163",
      name: "Pâtes crémeuses potiron & sauge",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Pâtes", quantity: "300 g", category: "" },
        { name: "Potiron en cubes", quantity: "200 g", category: "" },
        { name: "Oignon", quantity: "1", category: "" },
        { name: "Crème", quantity: "1 càs", category: "" },
        { name: "Sauge", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Cuire les pâtes.",
        "Faire revenir oignon et potiron.",
        "Ajouter un peu d’eau et cuire 10 minutes.",
        "Mixer légèrement et ajouter crème + sauge.",
        "Mélanger avec les pâtes.",
      ],
    },
    {
      id: "r164",
      name: "Salade tiède lentilles & courge rôtie",
      type: RecipeType.VEGE,
      durationMinutes: 25,
      difficulty: "Facile",
      ingredients: [
        { name: "Lentilles cuites", quantity: "200 g", category: "" },
        { name: "Courge (butternut ou potiron)", quantity: "200 g", category: "" },
        { name: "Oignon rouge", quantity: "1", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Citron", quantity: "1 càs", category: "" },
      ],
      steps: [
        "Couper la courge et la rôtir 15 minutes.",
        "Mélanger lentilles et oignon.",
        "Ajouter la courge tiède.",
        "Assaisonner huile + citron.",
      ],
    },
    {
      id: "r165",
      name: "Poulet rôti express aux herbes d’automne",
      type: RecipeType.VIANDE,
      durationMinutes: 25,
      difficulty: "Facile",
      ingredients: [
        ...
        { name: "Romarin", quantity: "1 càc", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Mélanger poulet, huile et herbes.",
        "Cuire à la poêle 10–12 minutes.",
    ...
    },
    {
      ...
      ingredients: [
        ...
        { name: "Bouillon", quantity: "500 ml", category: "" },
        { name: "Oignon", quantity: "1", category: "" },
        { name: "Parmesan (optionnel)", quantity: "1 càs", category: "" },
      ],
      steps: [
    ...
    {
      id: "r167",
      name: "Poêlée de courge & pois chiches",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Courge", quantity: "200 g", category: "" },
        { name: "Pois chiches", quantity: "1 boîte", category: "" },
        { name: "Paprika", quantity: "1 càc", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
      ],
      steps: [
        ...
        "Ajouter pois chiches et paprika.",
        "Cuire 10 minutes.",
      ],
    },
    {
      ...
      ingredients: [
        { name: "Œufs", quantity: "2", category: "" },
        { name: "Épinards", quantity: "100 g", category: "" },
        { name: "Crème", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Faire revenir épinards.",
        "Les mettre au fond d’un ramequin.",
        "Ajouter crème puis l’œuf.",
        "Cuire 10 min au four.",
      ],
    },
    {
      id: "r169",
      name: "Tartines automnales chèvre & miel",
      type: RecipeType.VEGE,
      durationMinutes: 10,
      difficulty: "Facile",
      ingredients: [
        { name: "Pain", quantity: "4 tranches", category: "" },
        { name: "Chèvre", quantity: "100 g", category: "" },
        { name: "Miel", quantity: "1 càs", category: "" },
        { name: "Thym", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Griller le pain.",
        "Étaler le chèvre.",
        "Ajouter miel et thym.",
        "Servir immédiatement.",
      ],
    },
    {
      id: "r170",
      name: "Potiron sauté ail & persil",
      type: RecipeType.VEGE,
      durationMinutes: 15,
      difficulty: "Facile",
      ingredients: [
        { name: "Potiron", quantity: "200 g", category: "" },
        { name: "Ail", quantity: "2 gousses", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Persil", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Couper potiron.",
        "Faire revenir ail.",
    ...
    {
      id: "r171",
      name: "Soupe hivernale carotte & gingembre",
      type: RecipeType.VEGE,
      durationMinutes: 25,
      difficulty: "Facile",
      ingredients: [
        { name: "Carottes", quantity: "4", category: "" },
        { name: "Pomme de terre", quantity: "1", category: "" },
        { name: "Gingembre râpé", quantity: "1 càc", category: "" },
        { name: "Eau ou bouillon", quantity: "500 ml", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Couper carottes et pomme de terre.",
        "Faire revenir légèrement avec gingembre.",
        "Ajouter eau et cuire 15 minutes.",
        "Mixer et saler.",
      ],
    },
    {
      id: "r172",
      name: "Poêlée chou kale & pois chiches",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Chou kale", quantity: "150 g", category: "" },
        { name: "Pois chiches", quantity: "1 boîte", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Paprika", quantity: "1 càc", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
    ...
    {
      id: "r173",
      name: "Gratin de courge butternut express",
      type: RecipeType.VEGE,
      durationMinutes: 25,
      difficulty: "Facile",
      ingredients: [
        { name: "Butternut", quantity: "300 g", category: "" },
        { name: "Oignon", quantity: "1", category: "" },
        { name: "Crème", quantity: "2 càs", category: "" },
        { name: "Fromage râpé", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Couper la courge en petits cubes.",
        "Faire revenir oignon.",
        "Ajouter courge et cuire 10 minutes.",
        "Mettre en plat, ajouter crème + fromage.",
        "Gratiner 8 minutes.",
      ],
    },
    {
      id: "r174",
      name: "Pâtes sauce crémeuse champignons",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
      ...
      steps: [
        "Cuire les pâtes.",
        "Faire revenir oignon + champignons.",
        "Ajouter crème et sel.",
        "Mélanger avec les pâtes.",
      ],
    },
    {
      id: "r175",
      name: "Poulet miel & moutarde hivernal",
      type: RecipeType.VIANDE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        ...
        { name: "Huile", quantity: "1 càc", category: "" },
      ],
      steps: [
        "Mélanger miel et moutarde.",
        "Enrober le poulet.",
        "Cuire à la poêle 10–12 minutes.",
      ],
    },
    {
      id: "r176",
      name: "Chou-fleur rôti paprika",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Chou-fleur", quantity: "1", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Paprika", quantity: "1 càc", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Couper chou-fleur en fleurettes.",
        "Mélanger avec huile et paprika.",
        "Cuire 15–18 minutes au four.",
      ],
    },
    {
      id: "r177",
      name: "Œufs brouillés au fromage",
      type: RecipeType.VEGE,
      durationMinutes: 10,
      difficulty: "Facile",
      ingredients: [
        { name: "Œufs", quantity: "3", category: "" },
        { name: "Fromage râpé", quantity: "30 g", category: "" },
        { name: "Beurre", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Battre les œufs.",
        "Faire fondre beurre.",
        "Cuire doucement les œufs.",
        "Ajouter fromage en fin de cuisson.",
      ],
    },
    {
      id: "r178",
      name: "Riz sauté hivernal légumes racines",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Riz cuit", quantity: "200 g", category: "" },
        { name: "Carotte", quantity: "1", category: "" },
        { name: "Panais", quantity: "1", category: "" },
        { name: "Sauce soja", quantity: "1 càs", category: "" },
      ],
      steps: [
        "Couper légumes.",
        "Faire revenir.",
        "Ajouter riz et sauce soja.",
        "Cuire 3 minutes.",
      ],
    },
    {
      id: "r179",
      name: "Poisson vapeur citron & herbes",
      type: RecipeType.POISSON,
      durationMinutes: 15,
      difficulty: "Facile",
      ingredients: [
      ...
      steps: [
        "Assaisonner poisson.",
        "Cuire vapeur 8 minutes.",
        "Ajouter citron et herbes.",
      ],
    },
    {
      id: "r180",
      name: "Poêlée pommes de terre & épinards",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Pommes de terre", quantity: "3", category: "" },
        { name: "Épinards", quantity: "100 g", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
    ...
    {
      id: "r181",
      name: "Salade de printemps asperges & œuf mollet",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
      ...
      steps: [
        "Couper les asperges et les cuire 5 minutes.",
        "Cuire les œufs 6 minutes.",
        "Assembler asperges + œufs.",
        "Assaisonner citron + huile.",
      ],
    },
    {
      id: "r182",
      name: "Pâtes petit pois & menthe",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Pâtes", quantity: "300 g", category: "" },
        { name: "Petits pois", quantity: "150 g", category: "" },
        { name: "Menthe", quantity: "1 càs", category: "" },
        { name: "Crème", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        ...
        "Mélanger crème + menthe.",
        "Assembler avec les pâtes.",
      ],
    },
    {
      id: "r183",
      name: "Poêlée de légumes nouveaux",
      type: RecipeType.VEGE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
        { name: "Carotte nouvelle", quantity: "1", category: "" },
        { name: "Courgette", quantity: "1", category: "" },
        { name: "Oignon nouveau", quantity: "1", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
    ...
    {
      id: "r184",
      name: "Saumon au citron & herbes fraîches",
      type: RecipeType.POISSON,
      durationMinutes: 15,
      difficulty: "Facile",
      ingredients: [
        { name: "Filets de saumon", quantity: "2", category: "" },
        { name: "Citron", quantity: "1 càs", category: "" },
        { name: "Herbes fraîches", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
    ...
    {
      id: "r185",
      name: "Salade radis, concombre & feta",
      type: RecipeType.VEGE,
      durationMinutes: 10,
      difficulty: "Facile",
      ingredients: [
        { name: "Radis", quantity: "1 botte", category: "" },
        { name: "Concombre", quantity: "1", category: "" },
        { name: "Feta", quantity: "100 g", category: "" },
        { name: "Citron", quantity: "1 càs", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
    ...
    {
      id: "r186",
      name: "Omelette aux herbes du printemps",
      type: RecipeType.VEGE,
      durationMinutes: 10,
      difficulty: "Facile",
      ingredients: [
        { name: "Œufs", quantity: "3", category: "" },
        { name: "Ciboulette", quantity: "1 càs", category: "" },
        { name: "Persil", quantity: "1 càs", category: "" },
        { name: "Sel", quantity: "1 pincée", category: "" },
      ],
      steps: [
        "Battre les œufs.",
        "Ajouter herbes.",
        "Cuire à la poêle 3 minutes.",
      ],
    },
    {
      id: "r187",
      name: "Risotto petits pois & citron",
      type: RecipeType.VEGE,
      durationMinutes: 25,
      difficulty: "Facile",
      ingredients: [
      ...
      steps: [
        ...
        "Ajouter petits pois et citron.",
        "Cuire 15 minutes.",
      ],
    },
    {
      id: "r188",
      name: "Poulet grillé ail & persil",
      type: RecipeType.VIANDE,
      durationMinutes: 20,
      difficulty: "Facile",
      ingredients: [
      ...
      steps: [
        "Mélanger poulet, ail et persil.",
        "Cuire 10–12 minutes.",
      ],
    },
    {
      id: "r189",
      name: "Tartine ricotta & asperges",
      type: RecipeType.VEGE,
      durationMinutes: 15,
      difficulty: "Facile",
      ingredients: [
        { name: "Pain", quantity: "4 tranches", category: "" },
        { name: "Asperges", quantity: "150 g", category: "" },
        { name: "Ricotta", quantity: "100 g", category: "" },
        { name: "Huile", quantity: "1 càs", category: "" },
      ],
      steps: [
